                    ...
                    <div class="profile-content">
                        ...
                        <div id="address">
                            ...
                            <button class="btn btn-add" type="button" data-bs-toggle="collapse"
                                data-bs-target="#addaddresstoggle" aria-expanded="false"
                                aria-controls="addaddresstoggle">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="country"
                                                placeholder="Enter Nepal">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="zcode" class="col-sm-2 col-form-label">Post Code</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="zcode"
