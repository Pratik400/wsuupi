          ...
          <div class="card h-100">
            <div class="card-body">
              ...
              <div class="list-group list-group-flush ">
                <a href="product.php" class="list-group-item list-group-item-action" aria-current="true">
                  <div class="d-flex w-100 justify-content-between">
                    <p class="mb-1">SSAF Payments</p>
        ...
        <div class="col-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Current Amount Due as at 27-Oct-2023 <h4>$0</h4></p>
              <p class="card-text">Account Balance <h4>$0.00</h4></p>
            </div>
          </div>
      ...
      <div class="row justify-content-start">
        ...
        <div class="col-4">
          <div class="list-group list-group-flush pay-type-card">
            ...
            <a href="product.php" class="list-group-item d-flex justify-content-between align-items-center">
